...
const sendAdminResetPasswordMail = async (email, name, token) => {
  try {
    const mailOptions = {
      ...
      html: `
                ...
                <a href="https://splendid-kringle-1d7238.netlify.app/reset/${token}"  
...
module.exports = sendAdminResetPasswordMail;
